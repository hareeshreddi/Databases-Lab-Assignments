...
int main()
{
	...
	while( fgets(buf1,maxstringlen,fp1)!=NULL )//copying each line into buf
	{
        ...
        printf(ff1,"insert into ett_temp values ('%d','%s','%s','%s','%s');\n",s5,s1,s2,s3,s4);
        printf(ff1,"insert into ett_clone values ('%d','%s','%s','%s','%s');\n",s5,s1,s2,s3,s4);
		free(temp1);
		free(temp2);
		free(temp3);
		free(temp4);
    ...
    fprintf(ff3,"insert into cwsl_temp values ('%s','%s','%s','%s','%s');\n",s1,s2,s3,s4,tt);
    fprintf(ff3,"insert into cwsl_clone values ('%s','%s','%s','%s','%s');\n",s1,s2,s3,s4,tt);
							free(temp1);
							free(temp2);
							free(temp3);
							free(temp4);
